...
// ── MAIN PAGE ──────────────────────────────────────────────────
export default function AFZPage({ onBack }) {
  ...
  return (
    <div className="afz-root">
      ...
      <nav className={`afz-nav${scrolled ? " scrolled" : ""}`}>
        <div className="afz-nav-logo">INCO<em>ZONE</em></div>
        <ul className="afz-nav-links">{["Services","Free Zones","About","Blog","Contact"].map(l=><li key={l}><a href="#">{l}</a></li>)}</ul>
        <button className="afz-nav-cta">Schedule Consultation</button>
      </nav>
