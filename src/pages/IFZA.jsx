...
// ── MAIN PAGE ─────────────────────────────────────────────────
export default function IFZAPage({ onBack }) {
  ...
  return (
    <div className="ifza-root">
      ...
      <nav className={`ifza-nav${scrolled ? " scrolled" : ""}`}>
        <div className="ifza-nav-logo">INCO<em>ZONE</em></div>
        <ul className="ifza-nav-links">{["Services","Free Zones","About","Blog","Contact"].map(l=><li key={l}><a href="#">{l}</a></li>)}</ul>
        <button className="ifza-nav-cta">Schedule Consultation</button>
      </nav>
