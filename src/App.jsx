...
const ZONES = [
  ...
  {
    id: "ajman", name: "AFZ", full: "Ajman Free Zone", category: "free",
  ...
  },
  {
    ...
    includes: [{ icon: "🏛️", title: "Regulated Framework", desc: "ADGM's internationally recognised legal framework" }, { icon: "💼", title: "Financial Activities", desc: "Asset management, fintech, banking and advisory" }, { icon: "📄", title: "Trade License", desc: "Official ADGM commercial license" }, { icon: "🌐", title: "Global Recognition", desc: "Recognised alongside DIFC as a top global IFC" }, { icon: "👤", title: "Visa Services", desc: "Investor and professional visa management" }, { icon: "🏦", title: "Tier-1 Banking", desc: "Introductions to Abu Dhabi's elite banks" }, { icon: "⚖️", title: "Legal Framework", desc: "English Common Law jurisdiction" }, { icon: "🔗", title: "PRO Services", desc: "Full government liaison and compliance" }],
    ...
    <>
      ...
      <section className="zone-finder" id="zone-finder">
        ...
        <div className="zf-grid">
          {filtered.map((zone, i) => (
            <div className={`zf-card reveal reveal-delay-${(i % 4) + 1}`} key={zone.id} onClick={() => { setSelectedZone(zone); window.scrollTo(0, 0); }}>
              {!skeletonDone && (
      ...
      <footer>
        <div className="footer-top">
          ...
          <div className="footer-col"><h5>Free Zones</h5><ul>{ZONES.map(z => <li key={z.id}><a href="#" onClick={e=>{e.preventDefault();setSelectedZone(z);window.scrollTo(0,0)}}>{z.name}</a></li>)}</ul></div>
