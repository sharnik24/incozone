...
const SECTORS = [
  { icon: "🏦", authority: "CBUAE", title: "Financial Services & Fintech", desc: "Central Bank of UAE approval required for payment services, lending, exchange, insurance, and financial technology platforms operating in the UAE.", approvals: ["Payment Service Provider", "Exchange House", "Lending License", "Insurance Permit", "Crypto Regulations", "Open Banking"] },
  { icon: "📈", authority: "SCA", title: "Investment & Securities", desc: "Securities & Commodities Authority regulates investment firms, brokers, fund managers, and platforms dealing in UAE-listed securities or commodities.", approvals: ["Investment Advisor", "Broker-Dealer", "Fund Manager", "Commodity Broker", "Portfolio Manager"] },
  { icon: "🏥", authority: "DHA / DOH", title: "Healthcare & Medical", desc: "Dubai Health Authority (DHA) and Department of Health Abu Dhabi (DOH) approval required for all healthcare facilities, clinics, pharmacies, and medical professionals.", approvals: ["Clinic License", "Pharmacy Permit", "Medical Professional", "Healthcare Facility", "Medical Device"] },
  { icon: "🎓", authority: "KHDA / ADEK", title: "Education & Training", desc: "Knowledge & Human Development Authority (Dubai) and ADEK (Abu Dhabi) regulate all educational institutions, training centres, and e-learning platforms.", approvals: ["School License", "Training Centre", "University Permit", "E-Learning Platform", "Tutoring Centre"] },
  { icon: "✈️", authority: "GCAA / CAA", title: "Aviation & Aerospace", desc: "General Civil Aviation Authority approval required for aviation services, drone operations, maintenance organisations, and aviation training in the UAE.", approvals: ["Air Operator Certificate", "Drone Permit", "MRO License", "Aviation Training", "Ground Handling"] },
  { icon: "📡", authority: "TDRA", title: "Telecom & Digital Media", desc: "Telecommunications & Digital Government Regulatory Authority approval required for telecoms services, frequency spectrum use, and digital media platforms.", approvals: ["ISP License", "Frequency Permit", "Content Provider", "OTT Platform", "Digital Media"] },
  { icon: "🍽️", authority: "Dubai Municipality / ADAFSA", title: "Food & Beverage", desc: "Dubai Municipality and Abu Dhabi Agriculture & Food Safety Authority require permits for all food production, distribution, import, and F&B establishments.", approvals: ["Food Trade License", "Import Permit", "Production Facility", "Restaurant Health", "Food Labelling"] },
  { icon: "⚡", authority: "DEWA / FEWA", title: "Energy & Utilities", desc: "Dubai Electricity & Water Authority and Federal Electricity & Water Authority approvals for energy services, renewable energy projects, and utility-related operations.", approvals: ["Energy Producer", "Solar Installation", "Water Treatment", "Utility Service", "EV Charging"] },
  { icon: "🏗️", authority: "Dubai DM / AD DMT", title: "Construction & Real Estate", desc: "Municipality and Real Estate Regulatory Authority (RERA) approvals for real estate brokerage, development, construction contracting, and property management.", approvals: ["RERA Broker Card", "Contractor Grade", "Developer Approval", "Property Manager", "Escrow Account"] },
];
