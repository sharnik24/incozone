  ...
  return (
    <div className="pro-root">
      ...
      <nav className={`pro-nav${scrolled?" scrolled":""}`}>
        <div className="pro-nav-logo">INCO<em>ZONE</em></div>
        <ul className="pro-nav-links">{["Services","Free Zones","About","Blog","Contact"].map(l=><li key={l}><a href="#">{l}</a></li>)}</ul>
        <button className="pro-nav-cta">Schedule Consultation</button>
      </nav>
