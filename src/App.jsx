...
const CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .wa-bubble { position: fixed; bottom: 100px; right: 28px; z-index: 299; background: #fff; border-radius: 12px 12px 0 12px; padding: 12px 16px; max-width: 210px; box-shadow: 0 4px 24px rgba(0,0,0,0.15); animation: waBubble 0.5s 3s cubic-bezier(0.16,1,0.3,1) both; pointer-events: none; }
  .wa-bubble::after { content: ''; position: absolute; bottom: -8px; right: 16px; width: 0; height: 0; border-left: 8px solid transparent; border-right: 0px solid transparent; border-top: 8px solid #fff; }
  .wa-bubble-name { font-family: 'DM Sans', system-ui, sans-serif; font-size: .65rem; font-weight: 600; color: #25D366; margin-bottom: 4px; }
  .wa-bubble-msg { font-family: 'DM Sans', system-ui, sans-serif; font-size: .72rem; color: #333; line-height: 1.5; }
  @keyframes waBubble { from { opacity: 0; transform: translateY(10px) scale(0.92); } to { opacity: 1; transform: translateY(0) scale(1); } }
  ...
  return (
    <div className="zone-page">
      ...
      <div className="wa-bubble" aria-hidden="true">
        <div className="wa-bubble-name">INCOZONE Advisory</div>
        <div className="wa-bubble-msg">Hi! Need help with UAE company setup? Chat with us now.</div>
      </div>
