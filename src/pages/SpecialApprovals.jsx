...
const SECTORS = [
  ...
  { icon: "", authority: "GCAA / CAA", title: "Aviation & Aerospace", desc: "General Civil Aviation Authority approval required for aviation services, drone operations, maintenance organisations, and aviation training in the UAE.", approvals: ["Air Operator Certificate", "Drone Permit", "MRO License", "Aviation Training", "Ground Handling"] },
  ...
  { icon: "", authority: "Dubai Municipality / ADAFSA", title: "Food & Beverage", desc: "Dubai Municipality and Abu Dhabi Agriculture & Food Safety Authority require permits for all food production, distribution, import, and F&B establishments.", approvals: ["Food Trade License", "Import Permit", "Production Facility", "Restaurant Health", "Food Labelling"] },
