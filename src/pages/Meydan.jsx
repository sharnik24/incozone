...
// ── MAIN PAGE ─────────────────────────────────────────────────
export default function MeydanPage({ onBack }) {
  ...
  return (
    <div className="myd-root">
      ...
      <nav className={`myd-nav${scrolled ? " scrolled" : ""}`}>
        <div className="myd-nav-logo">INCO<em>ZONE</em></div>
        <ul className="myd-nav-links">{["Services","Free Zones","About","Blog","Contact"].map(l=><li key={l}><a href="#">{l}</a></li>)}</ul>
        <button className="myd-nav-cta">Schedule Consultation</button>
      </nav>
